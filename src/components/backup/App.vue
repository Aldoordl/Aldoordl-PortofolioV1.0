...
onMounted(() => {
  ...
  // console.log("Total sections available:", allSection.value.length);
...
//   // Pastikan allSection.value sudah diinisialisasi dan bukan null atau undefined
//   if (allSection.value && allSection.value.length > 0) {
//     allSection.value.forEach(section => {
//       if (section) {
...
//     });
//   } else {
//     // Jika tidak ada section yang ditemukan, lakukan tindakan yang sesuai
//     // Misalnya, Anda bisa mencoba menginisialisasi allSection.value lagi atau hanya diam
//     console.log("Attempting to re-initialize sections.");
//     allSection.value = document.querySelectorAll(".section");
//     if (allSection.value.length > 0) {
//       allSection.value.forEach(section => {
//         section.classList.remove("back-section");
//       });
//     } else {
//       console.error("No sections found to remove 'back-section' class.");
//     }
//   }
// }

// function addBackSection(index) {
//   // Pastikan allSections sudah diinisialisasi dan indeks valid
//   if (allSection.value && index >= 0 && index < allSection.value.length) {
//     allSection.value[index].classList.add("back-section");
//   } else {
...
<!-- https://youtu.be/9xhnUrjTgB4?si=1EUHvHDOh55wDAmW -->